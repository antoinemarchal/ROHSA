...
module mod_optimize
  ...
  public :: gaussian, minimize_spec, minimize, myfunc_spec, myresidual, minimize_abs, minimize_new_abs
    ...
    do k=1, n_gauss
       ...
       do j=1, dim_x
          do i=1, dim_y
             ...
             dR_over_dB(1+(3*(k-1)),i,j) = dR_over_dB(1+(3*(k-1)),i,j) + (lambda_abs_amp_joint * &
