...
fitsname = path + "data/observation/GHIGLS_NEP_Tb.fits"
...
filename_parameters = path + "PARAMETERS/GHIGLS_NEP_Tb_parameters_run_4.txt"
filename = path + "DAT/GHIGLS_NEP_Tb.dat"
fileout = path + "ROHSA/GHIGLS_NEP_Tb_gauss_run_4.dat"
# filename_noise = path + "DAT/GHIGLS_NEP_Tb_rms.dat"
n_gauss = 12
lambda_amp = 1000.                                                                                                                      
lambda_mu = 1000.
lambda_sig = 1000.                                                                              
